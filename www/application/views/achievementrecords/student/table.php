                ...
                <tr>
                    ...
                    <? if($role == 'sadmin' OR $role == 'admin'):?>
                        <td style="text-align: center;">
                            <div id="actions">
                                <a title="edit" href="<?=URL::base()?><?=$role?>/achievementstudents/edit/<?=$student->student_id.
                                            '&'.$year.'&'.$record->id?>">
                                    <button class="action-button" value="">
                                        <img src="<?=URL::base()?>laguadmin/images/icons/pencil_gray.png">
                                    </button>
                                </a>
                                <button name="delete" value="<?=$student->student_id.'&'.$year.'&'.$record->id?>" data-toggle="modal" href="#deleteAchievementModal" 
...
<div style="display: none;" class="modal hide" id="deleteAchievementModal">
    <div class="tac">
        <form action="<?=URL::base()?><?=$role?>/achievementstudents/delete" method="post">
