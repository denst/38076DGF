<div id="tab-2">
    <div id="user-block">
        ...
        <?php endif; ?>
        <? if(isset($edit)):?> 
            <form class="formEl_a" action="<?php echo URL::base() ?><?=$role?>/achievementteachers/edit" method="POST">
        <? else:?>
            <form class="formEl_a" action="<?php echo URL::base() ?><?=$role?>/achievementteachers/create" method="POST">
        <? endif;?>
            <fieldset>
                <? if(isset($edit)):?>
