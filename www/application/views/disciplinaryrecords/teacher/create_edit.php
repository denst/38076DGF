 <div id="tab-2">
    <div id="user-block">
        ...
        <?php endif; ?>
        <? if(isset($edit)):?> 
            <form class="formEl_a" action="<?php echo URL::base() ?><?=$role?>/disciplinaryteachers/edit/" method="POST">
        <? else:?>
            <form class="formEl_a" action="<?php echo URL::base() ?><?=$role?>/disciplinaryteachers/create/" method="POST">
        <? endif;?>
            <fieldset>
                ...
                <div class="sepH_b">
                    <label for="name" class="lbl_a">Teacher:</label>
                    <div class="records content"><?php echo $teacher->name ?> <?php echo $teacher->fathername ?> <?php echo $teacher->grfathername ?></div>
                </div>
