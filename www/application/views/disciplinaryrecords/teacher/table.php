        ...
        <thead>
            <tr>
                ...
                <? if($role == 'sadmin' OR $role == 'admin'):?>
                    <th style="width: 60px"><div class="th_wrapp">Actions</div></th>
                <? endif?>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <? if($role == 'sadmin' OR $role == 'admin'):?>
                    <td style="text-align: center;">
                        <div id="actions">
                            <a href="<?php echo URL::base()?><?=$role?>/disciplinaryteachers/edit/<?php echo $teacher->teacher_id ?>&<?php echo $year ?>&<?php echo $record->id ?>" class="sepV_a" title="Edit">
                                <button class="action-button" value="">
                                    <img src="<?=URL::base()?>laguadmin/images/icons/pencil_gray.png" alt="" />
                                </button>
                            </a>
                            <button name="delete" value="<?=$teacher->teacher_id.'&'.$year.'&'.$record->id?>" data-toggle="modal" href="#deleteDisciplinaryModal" 
...
<div style="display: none;" class="modal hide" id="deleteDisciplinaryModal">
    <div class="tac">
        <form action="<?=URL::base()?><?=$role?>/disciplinaryteachers/delete" method="post">
