...
<legend>Semesters</legend>
    ...
    <table style="text-align: center"  cellpadding="0" cellspacing="0" border="0" class="table-records table_a smpl_tbl">
        <thead>
            <tr>
                <th <?=($role == 'sadmin' OR $role == 'admin')? 'colspan="2"': '' ?>><div class="th_wrapp">1st Semester Result</div></th>
                <th <?=($role == 'sadmin' OR $role == 'admin')? 'colspan="2"': '' ?>><div class="th_wrapp">2st Semester Result</div></th>
            </tr>
        </thead>
        <tbody>
            <tr>
