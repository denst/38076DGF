...
<ul class="fr cf" id="main_nav">
    <li class="nav_item <?=($conttroller == 'dashboard')? 'active': ''?> lgutipL" 
        title="Dashboard">
        <a href="<?=URL::base()?>admin/dashboard" class="main_link">
    ...
    <li class="nav_item <?=($conttroller == 'students' OR
        ...
        title="Studenst">
        <a href="<?=URL::base()?>admin/students/tab" class="main_link">
    ...
    <li class="nav_item <?=($conttroller == 'teachers' OR
        ...
        title="Teachers">
        <a href="<?=URL::base()?>admin/teachers/tab" class="main_link">
    ...
    <li class="nav_item <?=($conttroller == 'admins')? 'active': ''?> lgutipL" 
        ...
        <a href="<?=URL::base()?>admin/admins/tab" class="main_link">
    ...
    <li class="nav_item <?=($conttroller == 'levels' OR 
        ...
        title="Settings">
        <a href="<?=URL::base()?>admin/levels/list" class="main_link">
