<div class="cf">
        <div class="box_c">
            ...
            <div class="box_c_content cf">
                <a href="<?=URL::base()?>student/students/view/<?=$id?>">
                <? $student = $user->students->find();?>
                <img id="img-polaroid" class="sepV_b" alt="" src="<?=(Valid::not_empty($student->image))?
                    URL::base().'files/users/'.$student->student_id.'/46x46/'.$student->image: 
