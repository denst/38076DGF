<div id="tab-2">
    <div class="sepH_c">
            <table cellpadding="0" cellspacing="0" border="0" id="students_dropout_data_table" class="display">
                <thead>
                    <tr>
                        ...
                        <th><div class="th_wrapp">Begin</div></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?=URL::base() ?><?=$role?>/students/changedropout" method="post">
                                ...
                                <button class="btn btn_bS tb">Begin</button>
                            </form>
                        </td>
                        <td>
                            <div id="actions">
