...
--
-- Хост: localhost
-- Время создания: Мар 14 2013 г., 15:48
...
--
-- Структура таблицы `dg_clsss`
--

CREATE TABLE IF NOT EXISTS `dg_clsss` (
  `id` int(32) NOT NULL AUTO_INCREMENT,
  `year_id` int(32) NOT NULL,
  `tclass_id` int(32) NOT NULL,
  PRIMARY KEY (`id`),
...
(1, 'Pre-School', 1, 1000, 10),
(2, 'Kindergarten', 2, 1000, 10),
(3, 'Preparatory', 3, 0, 0),
(5, '2', 5, 1000, 10),
(6, '3', 6, 1000, 10),
(8, '5', 8, 0, 0),
...
(31, 'sadmin', '7ccee320217398736c5a085864cbacffdeec9d420f1de2855c4f8394ea52c601', 121, 1363239805, 1, 0);
...
--
-- Ограничения внешнего ключа таблицы `dg_clsss`
--
ALTER TABLE `dg_clsss`
  ADD CONSTRAINT `dg_clsss_ibfk_1` FOREIGN KEY (`tclass_id`) REFERENCES `dg_tmpl_clsss` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
